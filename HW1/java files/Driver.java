		...
		while(true) {
			...
			switch (selection) {
				...
				case 2:
					...
					if(index != -1) {
						employee(company.getEmployees().at(index));
					}
					else {
						System.out.println("Invalid mail or password!");
					}
				...
				case 3:
					...
					if(index != -1) {
						customer(company.getCustomers().at(index));
					}
					else {
						System.out.println("Invalid mail or password!");
					}
		...
		while(true) {
			...
			case 2:
				...
				for(int i=0;i<admin.getCompany().getBranches().size();i++) {
					if(admin.getCompany().getBranches().at(i).getName().equals(information)) {
						flag = true;
					}
				}
				if(flag == false) {
			...
			case 4:
				...
				if(admin.removeBranchEmployee(name, surname,company)) {
					...
					for(int i=0;i<admin.getCompany().getEmployees().size();i++) {
						System.out.println(admin.getCompany().getEmployees().at(i));
					}
				}
				else {
		...
		if(customer.search_chair(model, color,chair) != null) {
			...
			case 1:
				...
				for(int i=0;i<customer.getCompany().getEmployees().size();i++) {
					if(customer.getCompany().getEmployees().at(i).getInformation().equals(chair.getBranchname())){
						if(customer.getCompany().getEmployees().at(i).removeChair(chair.getModel(),chair.getColor(),quantity)) {
							myObj.nextLine();
							System.out.println("Please enter an addres:");
							adress = myObj.nextLine();
							System.out.println("Please enter an number:");
	...
	public static void searchDesk(Customer customer,String model,String color) {
		...
		if(customer.search_desk(model, color,desk) != null) {
			...
			case 1:
				...
				quantity = myObj.nextInt();
				for(int i=0;i<customer.getCompany().getEmployees().size();i++) {
					if(customer.getCompany().getEmployees().at(i).getInformation().equals(desk.getBranchname())){
						if(customer.getCompany().getEmployees().at(i).removeDesk(desk.getModel(),desk.getColor(),quantity)) {
							myObj.nextLine();
							System.out.println("Please enter an addres:");
							adress = myObj.nextLine();
							System.out.println("Please enter an number:");
	...
	public static void searchCabinet(Customer customer,String model) {
		...
		if(customer.search_cabinet(model,cabinet) != null) {
			...
			case 1:
				...
				quantity = myObj.nextInt();
				for(int i=0;i<customer.getCompany().getEmployees().size();i++) {
					if(customer.getCompany().getEmployees().at(i).getInformation().equals(cabinet.getBranchname())){
						if(customer.getCompany().getEmployees().at(i).removeCabinet(cabinet.getModel(),quantity)) {
							myObj.nextLine();
							System.out.println("Please enter an addres:");
							adress = myObj.nextLine();
							System.out.println("Please enter an number:");
	...
	public static void searchBookcase(Customer customer,String model) {
		...
		if(customer.search_bookcase(model,bookcase) != null) {
			...
			case 1:
				...
				quantity = myObj.nextInt();
				for(int i=0;i<customer.getCompany().getEmployees().size();i++) {
					if(customer.getCompany().getEmployees().at(i).getInformation().equals(bookcase.getBranchname())){
						if(customer.getCompany().getEmployees().at(i).removeBookcase(bookcase.getModel(),quantity)) {
							myObj.nextLine();
							System.out.println("Please enter an addres:");
							adress = myObj.nextLine();
							System.out.println("Please enter an number:");
	...
	public static void searchMeetingtable(Customer customer,String model,String color) {
		...
		if(customer.search_desk(model, color,table) != null) {
			...
			case 1:
				...
				quantity = myObj.nextInt();
				for(int i=0;i<customer.getCompany().getEmployees().size();i++) {
					if(customer.getCompany().getEmployees().at(i).getInformation().equals(table.getBranchname())){
						if(customer.getCompany().getEmployees().at(i).removeMeetingtable(table.getModel(),table.getColor(),quantity)) {
							myObj.nextLine();
							System.out.println("Please enter an addres:");
							adress = myObj.nextLine();
							System.out.println("Please enter an number:");
