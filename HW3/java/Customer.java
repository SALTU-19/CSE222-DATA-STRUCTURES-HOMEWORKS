...
public class Customer implements Person {
	...
	public OfficeChairs search_chair(String model, String color,OfficeChairs chair) {
		for(int i=0;i<getCompany().getBranches().size();i++) {
			for(int j=0;j<getCompany().getBranches().get(i).getChairs().size();j++) {
				if(getCompany().getBranches().get(i).getChairs().get(j).equals(new OfficeChairs(model,color,null))) {
					chair = getCompany().getBranches().get(i).getChairs().get(j);
					return chair;
				}
			}
		}
	...
	public OfficeDesks search_desk(String model, String color,OfficeDesks desk) {
		for(int i=0;i<getCompany().getBranches().size();i++) {
			for(int j=0;j<getCompany().getBranches().get(i).getDesks().size();j++) {
				if(getCompany().getBranches().get(i).getDesks().get(j).equals(new OfficeDesks(model,color,null))) {
					desk = getCompany().getBranches().get(i).getDesks().get(j);
					return desk;
				}
			}
		}
	...
	public OfficeCabinets search_cabinet(String model,OfficeCabinets cabinet) {
		for(int i=0;i<getCompany().getBranches().size();i++) {
			for(int j=0;j<getCompany().getBranches().get(i).getCabinets().size();j++) {
				if(getCompany().getBranches().get(i).getCabinets().get(j).equals(new OfficeCabinets(model,null))) {
					cabinet = getCompany().getBranches().get(i).getCabinets().get(j);
					return cabinet;
				}
			}
		}
	...
	public BookCases search_bookcase(String model,BookCases bookcase) {
		for(int i=0;i<getCompany().getBranches().size();i++) {
			for(int j=0;j<getCompany().getBranches().get(i).getBookcases().size();j++) {
				if(getCompany().getBranches().get(i).getBookcases().get(j).equals(new BookCases(model,null))) {
					bookcase = getCompany().getBranches().get(i).getBookcases().get(j);
					return bookcase;
				}
			}
		}
	...
	public MeetingTables search_desk(String model, String color,MeetingTables table) {
		for(int i=0;i<getCompany().getBranches().size();i++) {
			for(int j=0;j<getCompany().getBranches().get(i).getMeetingtables().size();j++) {
				if(getCompany().getBranches().get(i).getMeetingtables().get(j).equals(new MeetingTables(model,color,null))) {
					table = getCompany().getBranches().get(i).getMeetingtables().get(j);
					return table;
				}
			}
		}
	 ...
	 */
	public KWArrayList<Order> getOrder(){
		return orders;
	}
	/**
